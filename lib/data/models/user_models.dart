class UserModel {
  UserModel({this.results, this.info, this.error});

  UserModel.fromJson(Map<String, dynamic> json) {
    if (json['results'] != null) {
      results = <UserApiResults>[];
      json['results'].forEach((v) {
        results!.add(UserApiResults.fromJson(v));
      });
    }
    info = json['info'] != null ? Info.fromJson(json['info']) : null;
  }
  List<UserApiResults>? results;
  Info? info;
  String? error;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (results != null) {
      data['results'] = results!.map((UserApiResults v) => v.toJson()).toList();
    }
    if (info != null) {
...
class UserApiResults {
  ...
  UserApiResults.fromJson(Map<String, dynamic> json) {
    gender = json['gender'];
